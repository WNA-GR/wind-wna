...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'lower', 'includes/main_menu.tpl', 133, false),array('modifier', 'escape', 'includes/main_menu.tpl', 176, false),)), $this); ?>
...
" class="menu-link"><?php echo $this->_tpl_vars['lang']['home']; ?>
					...
					<td class="table-small-menu-text"><a href="../forum" class="menu-link">WNA forum</a></td>
		              ...
		              <tr bgcolor="#FFFFFF">
					<td class="table-small-menu-text"><a href="../wiki/WiND" class="menu-link">Οδηγίες χρήσης</a></td>
				</tr>
...
"><?php echo $this->_tpl_vars['lang']['all_services']; ?>
				...
				<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/services.gif" width="16" height="16" alt="<?php echo $this->_tpl_vars['lang']['nodechangeslog']; ?>
" />&nbsp;<a href="<?php echo $this->_tpl_vars['link_nodechangeslog']; ?>
"><?php echo $this->_tpl_vars['lang']['nodechangeslog']; ?>
</a></td>
		  		</tr>
			  	<tr>
...
"><?php echo $this->_tpl_vars['lang']['node_add']; ?>
			...
			<td class="table-form-title"><img src="templates/basic/images/gmap/modern/nodes/home.png" alt="σημείο όπου έχετε δηλώσει πως μένετε" 
			>
			&nbsp;
			<?php if ($this->_tpl_vars['home_node']): ?><a href="<?php echo $this->_tpl_vars['mynodes'][0]['url_view']; ?>
">Home Node (<?php echo ((is_array($_tmp=$this->_tpl_vars['home_node'][0]['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
 (#<?php echo $this->_tpl_vars['home_node'][0]['id']; ?>
)</a>)&nbsp;
					<br />
					<span style="font-weight:bold; font-size: 7px; color: orange;">|<a href="<?php echo $this->_tpl_vars['home_node'][0]['url']; ?>
...
">action log</a></td>
				...
				<?php if ($this->_tpl_vars['link_admin_nodechangeslog'] != ''): ?>
				<tr class="table-form-row1">
					<td colspan="2" class="table-form-title"><img src="templates/basic/images/areas-small.png" alt="<?php echo $this->_tpl_vars['lang']['areas']; ?>
" />&nbsp;<a href="<?php echo $this->_tpl_vars['link_admin_nodechangeslog']; ?>
">node changes log</a></td>
				</tr>
				<?php endif; ?>
