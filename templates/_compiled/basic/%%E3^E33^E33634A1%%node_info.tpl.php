<?php /* Smarty version 2.6.19, created on 2014-06-08 10:27:52
         compiled from includes/pages/nodes/node_info.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'includes/pages/nodes/node_info.tpl', 29, false),array('modifier', 'date_format', 'includes/pages/nodes/node_info.tpl', 65, false),)), $this); ?>
<!-- start node_info_tpl -->
...
<tr>
<td class="table-node-key"> </td>
<td class="table-node-value"><a href="http://<?php echo ((is_array($_tmp=$this->_tpl_vars['node']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.wna.gr">http://<?php echo ((is_array($_tmp=$this->_tpl_vars['node']['name'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
.wna.gr</a></td>
</tr>
<tr>
...
<tr>
<td class="table-node-key"> <?php echo $this->_tpl_vars['lang']['db']['nodes__nodestatus']; ?>
</td>
<td class="table-node-value"><?php echo ((is_array($_tmp=$this->_tpl_vars['node']['nodestatus'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
</tr>
<tr>
...
<tr>
<td class="table-node-key"> <?php echo $this->_tpl_vars['lang']['db']['nodes__last_modified']; ?>
</td>
<td class="table-node-value"><?php echo ((is_array($_tmp=$this->_tpl_vars['node']['date_modified'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y %H:%M:%S") : smarty_modifier_date_format($_tmp, "%d/%m/%Y %H:%M:%S")); ?>
</td>
</tr>
<tr>
<td class="table-node-key"> <?php echo $this->_tpl_vars['lang']['db']['nodes__autonomy']; ?>
</td>
<td class="table-node-value"><?php echo $this->_tpl_vars['node']['autonomy']; ?>
</td>
</tr>
<tr>     
</tr>
