<?php /* Smarty version 2.6.19, created on 2014-05-18 15:43:54
         compiled from includes/pages/hostmaster/hostmaster_dnszone_form_zone.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'includes/pages/hostmaster/hostmaster_dnszone_form_zone.tpl', 28, false),array('modifier', 'escape', 'includes/pages/hostmaster/hostmaster_dnszone_form_zone.tpl', 28, false),)), $this); ?>
<?php echo '
...
] = '<?php echo ((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['lang']['email']['zone'][$this->_tpl_vars['lng']]['subject'])) ? $this->_run_mod_handler('replace', true, $_tmp, "##zone##", ($this->_tpl_vars['data']['0']['value'])) : smarty_modifier_replace($_tmp, "##zone##", ($this->_tpl_vars['data']['0']['value']))))) ? $this->_run_mod_handler('replace', true, $_tmp, "\r", "\\r") : smarty_modifier_replace($_tmp, "\r", "\\r")))) ? $this->_run_mod_handler('replace', true, $_tmp, "\n", "\\n") : smarty_modifier_replace($_tmp, "\n", "\\n")))) ? $this->_run_mod_handler('escape', true, $_tmp, 'quotes') : smarty_modifier_escape($_tmp, 'quotes')); ?>
'
	<?php endfor; endif; ?>
	var arr_b = new Array()
	<?php unset($this->_sections['e']);
...
<?php if ($this->_tpl_vars['data']['1']['Null'] != 'YES'): ?>*<?php endif; ?>:</td><td class="table-form-field"><textarea class="fld-form-input" name="<?php echo $this->_tpl_vars['data']['1']['fullField']; ?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['data']['1']['value'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</textarea></td></tr>
...
[]" size="5" multiple="multiple">
			<?php unset($this->_sections['e']);
$this->_sections['e']['loop'] = is_array($_loop=$this->_tpl_vars['data']['2']['Type_Pickup']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['e']['name'] = 'e';
$this->_sections['e']['show'] = true;
$this->_sections['e']['max'] = $this->_sections['e']['loop'];
$this->_sections['e']['step'] = 1;
...
$this->_sections['e']['last']       = ($this->_sections['e']['iteration'] == $this->_sections['e']['total']);
?>
			<?php $this->assign('value', $this->_tpl_vars['data']['2']['Type_Pickup'][$this->_sections['e']['index']]['value']); ?>
			<option value="<?php echo ((is_array($_tmp=$this->_tpl_vars['data']['2']['Type_Pickup'][$this->_sections['e']['index']]['value'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
" selected="selected"><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "constructors/form_enum.tpl", 'smarty_include_vars' => array('fullField' => $this->_tpl_vars['fullField'],'value' => $this->_tpl_vars['data']['2']['Type_Pickup'][$this->_sections['e']['index']]['output'])));
...
$this->_smarty_include(array('smarty_include_tpl_file' => "generic/link.tpl", 'smarty_include_vars' => array('content' => ($this->_tpl_vars['lang']['add']),'onclick' => "javascript: t = window.open('".($this->_tpl_vars['data']['2']['Pickup_url'])."', 'popup_pickup', 'width=700,height=600,toolbar=0,resizable=1,scrollbars=1'); t.focus(); return false;")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "generic/link.tpl", 'smarty_include_vars' => array('content' => ($this->_tpl_vars['lang']['remove']),'onclick' => "javascript: remove_selected(window.document.".($this->_tpl_vars['extra_data']['FORM_NAME']).".elements['".($this->_tpl_vars['data']['2']['fullField'])."[]']); return false;")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
	</td>	
