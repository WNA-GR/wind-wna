<?php /* Smarty version 2.6.19, created on 2014-05-18 12:43:23
         compiled from includes/pages/mynodes/mynodes_services.tpl */ ?>
<?php ob_start();
$_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "generic/help.tpl", 'smarty_include_vars' => array('help' => "mynodes_services_".($this->_tpl_vars['services_method']))));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
$this->assign('help', ob_get_contents()); ob_end_clean();
 ?>
<?php $this->assign('t', "services_".($this->_tpl_vars['services_method'])); ?>
