	...
	<tr>
		<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-search-menu">
				...
				<tr>
					<td class="table-search-menu-text"><img src="templates/basic/images/services.gif" width="16" height="16" alt="{$lang.nodechangeslog}" />&nbsp;<a href="{$link_nodechangeslog}">{$lang.nodechangeslog}</a></td>
		  		</tr>
			  	<tr>
...
<br>{$stats_nodes_active}/{$stats_nodes_total} <span style="color: black;">{$lang.active_nodes|lower}</span></td>
   ...
   <tr>
		<td class="search-menu">
			...
			>
			&nbsp;
			{if $home_node}<a href="{$mynodes[0].url_view}">Home Node ({$home_node[0].name|escape} (#{$home_node[0].id})</a>)&nbsp;
					<br />
					<span style="font-weight:bold; font-size: 7px; color: orange;">|<a href="{$home_node[0].url}">{$lang.edit_node}
	...
	<tr>
		<td class="search-menu">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table-mynodes">
				...
				{if $link_admin_nodechangeslog != ''}
				<tr class="table-form-row1">
					<td colspan="2" class="table-form-title"><img src="templates/basic/images/areas-small.png" alt="{$lang.areas}" />&nbsp;<a href="{$link_admin_nodechangeslog}">node changes log</a></td>
				</tr>
				{/if}
