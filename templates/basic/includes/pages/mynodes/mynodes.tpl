...
<tr>
<td class="table-page-pad">
{include assign="t1" file="generic/link.tpl" link=$link_nodesettingschanges_add content="`$lang.nodesettingschanges_add`"}
{include file=generic/title2.tpl title="`$lang.nodesettingschanges` $t1" content=$table_nodesettingschanges}
</td>
</tr>
<tr>
<td class="table-page-pad">
