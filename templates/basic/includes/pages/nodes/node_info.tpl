...
<td class="table-node-value"><a href="http://{$node.name|escape}.wna.gr">http://{$node.name|escape}.wna.gr</a></td>
</tr>
<tr>
...
<tr>
<td class="table-node-key"> {$lang.db.nodes__nodestatus}</td>
<td class="table-node-value">{$node.nodestatus|escape}</td>
</tr>
<tr>
...
<tr>
<td class="table-node-key"> {$lang.db.nodes__last_modified}</td>
<td class="table-node-value">{$node.date_modified|date_format:"%d/%m/%Y %H:%M:%S"}</td>
</tr>
<tr>
<td class="table-node-key"> {$lang.db.nodes__autonomy}</td>
<td class="table-node-value">{$node.autonomy}</td>
</tr>
<tr>     
</tr>
<tr>
...
<td class="table-node-value"><!--<a href="/forum/userinfo.php?username={$node.owner_username}">{$node.owner_username|escape} (contact)</a> -->
 {$node.owner_username|escape}{include file="generic/link.tpl" onclick="javascript: t = window.open('$link_contact', 'contact', 'width=700,height=600,toolbar=0,resizable=1,scrollbars=1'); t.focus(); return false;" content=$lang.contact} | <a href="/forum/searchnodes.php?username={$node.owner_username}">Other nodes</a>
</td>
</tr>
</table>
