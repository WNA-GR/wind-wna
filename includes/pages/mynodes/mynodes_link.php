...
class mynodes_link {
	...
	function form_link() {
		...
		$form_link->db_data('links.type, links.peer_node_id, links.peer_ap_id, links.protocol, links.ssid, links.channel,  links.status, links.equipment, links.info, links.security, links.ip, links.hs_logged_in_msg, links.tspeed, links.throughput, links.ospfcost');#@#
