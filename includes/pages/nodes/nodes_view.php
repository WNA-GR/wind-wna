...
class nodes_view {
	...
	function output() {
		...
		$this->tpl['node'] = $db->get(
			'nodes.id, nodes.name, nodes.community_id as community_id, nodes.com_wind_id as com_wind_id, communities.name as community_name, communities.windURL as community_windURL, nodes.date_in, nodes.last_modified as date_modified, nodes.latitude, nodes.longitude, nodes.elevation, nodes.info, nodes.internetaccess as node__internetaccess, nodes.internetprovider as node__internetprovider, areas.name as area_name, regions.name as region_name, regions.dns_suffix as region_dnssuffix, users.username AS owner_username, users.email AS owner_email, nodes.declared_status as nodestatus, nodes.autonomy_minutes as autonomy',
			'nodes
